...
MAX_BADGE_CHECK_COUNT = 4  # How many times a full BUFFER should be checked before a person is declared to be an imposter
...
@app.route('/state_info', methods=[ 'GET','POST'])
def state_info():
...
@app.route('/camera_manager', methods=[ 'GET','POST'])
def camera_manager():
