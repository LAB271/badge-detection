...
hikvision_prerec = SurveillanceCamera('labs-preREC', person_detection_model, badge_detection_model, badge_classification_model, [1, 2, 3, 4, 5], os.path.join('output', 'recordings', 'Camera hikvision - 29-07-2021_19-37-35.mp4'), 10, 10, 10, 10, 3, record='output/simulation')
print("-------------------------")
